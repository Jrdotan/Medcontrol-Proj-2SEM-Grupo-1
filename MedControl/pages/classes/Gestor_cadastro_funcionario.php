...
class funcionario extends cadastro_funcionario{
    ...
    public function __construct($nomeCompleto, $password, $senhaRepetida, $email, $sexo, $idade, $cargo, $cpf){
    ...
    public function validar_cadastro_funcionario() // Valida cadastro se nenhum erro for encontrado no formulário preenchido
    {
        ...
        $this->set_usuario($this->nomeCompleto, $this->password, $this->email, $this->sexo, $this->idade, $this->cargo, $this->cpf); // Executa instruções continas na função para 
